...
<div class="wrap">
	...
	<h1><?php _e( 'Kleinanzeigen-Credits senden', $this->text_domain ); ?></h1>

	<form action="#" method="post">
		<table class="form-table">
			<tr>
				<th><label for="manage_credits"><?php _e( 'Guthaben an Kleinanzeigen-Mitglieder senden', $this->text_domain ); ?></label></th>
				<td>
