		...
		<div class="inside">
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						<code><strong>[cf_my_credits_btn text="<?php _e('Meine Kleinanzeigen Credits', $this->text_domain);?>" view="loggedin | loggedout | both"]</strong></code> or
				...
				<tr>
					...
					<td>
						...
						<br /><span class="description"><?php _e( 'Link zur Classifeds-Checkout-Seite. Erzeugt einen &lt;button&gt; &lt;/button&gt; mit den von Dir definierten Inhalten.', $this->text_domain ) ?></span>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php _e( 'Kleinanzeige hinzufügen-Schaltfläche:', $this->text_domain ) ?></th>
					<td>
						<code><strong>[cf_add_classified_btn text="<?php _e('Kleinanzeige hinzufügen', $this->text_domain);?>" view="loggedin | loggedout | both"]</strong></code> or
				...
				<tr>
					...
					<td>
						<code><strong>[cf_profile_btn text="<?php _e('Profil', $this->text_domain);?>" view="loggedin | loggedout | both"]</strong></code> or
				...
				<tr>
					...
					<td>
						<code><strong>[cf_signin_btn text="<?php _e('Anmelden', $this->text_domain);?>" view="loggedin | loggedout | both"]</strong></code> or
