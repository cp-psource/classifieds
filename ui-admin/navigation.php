...
<h2>
	...
	<a class="nav-tab <?php if ( $tab == 'capabilities' || empty($tab))  echo 'nav-tab-active'; ?>" href="<?php echo esc_attr('admin.php?page=classifieds_settings&tab=capabilities');?>" ><?php _e( 'Fähigkeiten', $this->text_domain ); ?></a>
	...
	<a class="nav-tab <?php if ( $tab == 'send-credits' || empty( $tab) )  echo 'nav-tab-active'; ?>" href="<?php echo esc_attr('admin.php?page=classifieds_credits&tab=send-credits'); ?>" ><?php _e( 'Sende Guthaben', $this->text_domain ); ?></a>
	<?php endif; ?>
