						...
						<td>
							<p>
								<label>
									...
									<?php _e( 'Kostenlose Kleinanzeigen', $this->text_domain ) ?>
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							...
							<p>
								<label><?php _e('Transaktionsschlüssel', $this->text_domain) ?><br />
					...
					<tr>
						<th>
							<label for="an_cancel_url"><?php _e( 'Weiterleitungs-URL bei Abbrechen:', $this->text_domain ) ?></label>
						</th>
						<td>
					...
					<tr>
						...
						<td>
							<span class="description"><?php _e('Optionale Einstellungen zur Steuerung erweiterter Optionen', $this->text_domain) ?></span>
							<!--
							<p>
							...
							<p>
								<label><a title="<?php _e('Fordere eine abgegrenzte Antwort vom Zahlungsgateway an.', $this->text_domain); ?>"><?php _e('Delim-Daten:', $this->text_domain); ?></a><br/>
									...
									<select name="authorizenet[delim_data]" style="width:100px">
										<option value="yes" <?php selected($delim_data == 'yes') ?>><?php _e('Ja', $this->text_domain) ?></option>
										<option value="no" <?php selected($delim_data == 'no') ?>><?php _e('Nein', $this->text_domain) ?></option>
									</select>
								</label>
							</p>
							<!--
							<p>
							<label><a title="<?php _e('Viele andere Gateways verfügen über Authorize.net-API-Emulatoren. Um eines dieser Gateways zu verwenden, gib hier seine API-Post-URL ein.', $this->text_domain); ?>"><?php _e('Custom API URL', $this->text_domain) ?></a><br />
